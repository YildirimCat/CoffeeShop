...
public class LARExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LARDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LARStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LARDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LARDateTimeConverter dateTimeConverter = new LARStandardDateTimeConverter();

    public LARExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LARExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LARMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LARHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LARExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LARHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
