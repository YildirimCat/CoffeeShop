...
public class LARKPSPublicSoap
{
    ...
    public LARKPSPublicSoap(){}

    public LARKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LARKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LARExtendedSoapSerializationEnvelope envelope= new LARExtendedSoapSerializationEnvelope(LARExtendedSoapSerializationEnvelope.VER11);
